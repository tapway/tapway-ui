...
<div class="section-body">
  <div class="panel">
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <div id="chart1"><img src="assets/images/dummy-images/dummy-chart-01.jpg" alt="" class="img-responsive"></div>
      </div>
    </div><!-- /.row 1 -->
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <div id="chart2"><img src="assets/images/dummy-images/dummy-chart-01.jpg" alt="" class="img-responsive"></div>
        <div id="chart3"><img src="assets/images/dummy-images/dummy-chart-02.jpg" alt="" class="img-responsive"></div>
      </div>
    </div><!-- /.row 2 -->
